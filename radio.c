...
#ifdef EXTENDED_QRP
	pInfo->TXP_MaxSetting = pInfo->TXP_CalculatedSetting;
#endif
	// *******************************
}
...
void RADIO_SetupRegisters(bool switchToForeground)
{
...
#endif
	{
		...
		{ // FM
			...
			case CODE_TYPE_CONTINUOUS_TONE:
				...
				InterruptMask = 0 | BK4819_REG_3F_CxCSS_TAIL | BK4819_REG_3F_CTCSS_FOUND | BK4819_REG_3F_CTCSS_LOST | BK4819_REG_3F_SQUELCH_FOUND | BK4819_REG_3F_SQUELCH_LOST;
			...
			case CODE_TYPE_REVERSE_DIGITAL:
				...
				InterruptMask = 0 | BK4819_REG_3F_CxCSS_TAIL | BK4819_REG_3F_CDCSS_FOUND | BK4819_REG_3F_CDCSS_LOST | BK4819_REG_3F_SQUELCH_FOUND | BK4819_REG_3F_SQUELCH_LOST;
				break;
			}
	...
	else
	{
		...
		InterruptMask = 0 | BK4819_REG_3F_CTCSS_FOUND | BK4819_REG_3F_CTCSS_LOST | BK4819_REG_3F_SQUELCH_FOUND | BK4819_REG_3F_SQUELCH_LOST;
	}
#endif
...
void RADIO_SetupAGC(bool listeningAM, bool disable)
{
	...
	if (!listeningAM)
	{ // if not actively listening AM we don't need any AM specific regulation
...
#ifdef ENABLE_AM_FIX
		if (gSetting_AM_fix)
		{ // if AM fix active lock AGC so AM-fix can do it's job
			BK4819_SetAGC(0);
